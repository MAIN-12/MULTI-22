  ...
  Adafruit_NeoPixel rgb = Adafruit_NeoPixel(3, BOARD_LED_PIN_WS2812, NEO_GRB + NEO_KHZ400);
#endif
...
public:
  ...
  // };
    ...
    COLOR_BLUE    = RGB(186, 219, 0xFF),
    COLOR_BLYNK   = RGB(0x00, 0x00, 0xFF),
...
protected:
  ...
  void setRGB(uint32_t color) {
    ...
    // rgb.setPixelColor(0, color);
    rgb.setPixelColor(1, color);
    rgb.setPixelColor(2, color);
    delay(10);
    rgb.show();
  }
